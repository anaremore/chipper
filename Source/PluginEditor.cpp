...
void ChipperAudioProcessorEditor::resized()
{
    ...
    const auto performanceStripHeight = sidLayout ? 260 : (paulaLayout ? 180 : (spc700Layout ? 176 : (sampleLayout ? 200 : (nesLayout ? 318 : (wavetableLayout ? 260 : 300)))));
    ...
    else if (paulaLayout)
    {
        ...
        const auto sampleRowHeight = std::clamp(desiredSampleRowHeight, std::min(300, maximumSampleRowHeight), std::min(380, maximumSampleRowHeight));
