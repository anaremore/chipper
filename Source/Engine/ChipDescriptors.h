...
uint8_t ym2413RhythmBassDrumVolumeForPatch(const PatchConfig& patch, float velocity = 1.0f);
uint8_t ym2413RhythmHatVolumeForPatch(const PatchConfig& patch, float velocity = 1.0f);
uint8_t ym2413RhythmSnareVolumeForPatch(const PatchConfig& patch, float velocity = 1.0f);
uint8_t ym2413RhythmTomVolumeForPatch(const PatchConfig& patch, float velocity = 1.0f);
uint8_t ym2413RhythmCymVolumeForPatch(const PatchConfig& patch, float velocity = 1.0f);
