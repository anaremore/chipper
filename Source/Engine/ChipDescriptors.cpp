...
std::vector<ChipParameterSpec> huc6280ParameterSpecs()
{
    return {
        ...
        envelopeSpec("huc6280.decay", "Channel Amp Env", "Applies a modern musical helper over HuC6280 channel volume; native 5-bit volume state remains visible in debug output."),
        segmentedSpec(ChipParameterRole::dmgStereoRoute,
                      "huc6280.lfoPair",
                      "Ch 1/2 LFO",
                      "Motion",
...
std::vector<ChipParameterSpec> sccParameterSpecs()
{
    return {
        ...
        envelopeSpec("scc.decay", "Wave Amp Env", "Applies a modern musical helper over SCC channel volume; native key and 4-bit volume registers remain visible in debug output."),
...
std::vector<ChipParameterSpec> namcoWsgParameterSpecs()
{
    return {
        ...
        envelopeSpec("namcoWsg.decay", "Lane Amp Env", "Applies a modern musical helper over Namco WSG lane volume; native 4-bit volume and enable state remain visible in debug output."),
