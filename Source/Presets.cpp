...
const std::vector<PresetQualityTarget>& presetQualityTargets()
{
    ...
    static const std::vector<PresetQualityTarget> targets {
        ...
        { ChipMode::opl3, roles, { "fm", "operator", "rhythm", "wave", "bell", "4op" }, "Furnace-informed OPL coverage: two-op melodic voices, first-pass $104 4-op pairs, rhythm mode, bells, basses, and DOS-style SFX." },
