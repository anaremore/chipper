...
const std::vector<PresetInfo>& presetCatalog()
{
    static const std::vector<PresetInfo> presets {
        ...
        },
        {
            ...
            "YM2612 / OPN2",
            "OPN2 DAC Kick",
            "Channel-6 YM2612 DAC drum hit using Chipper's generated unsigned DAC byte playback path.",
            ChipMode::ym2612,
            AccuracyMode::hybrid,
            MacroKind::drum,
            PlayMode::stack,
        ...
        withSourceLevels(
            {
                ...
                "YM2151 / OPM",
                "OPM Hollow Pad",
                "Sustained YM2151 pad stack with softer feedback, native LFO motion, and wide arcade-style tone.",
                ChipMode::ym2151,
                AccuracyMode::hybrid,
                MacroKind::lead,
                PlayMode::stack,
        ...
        },
        {
            ...
            "YM2151 / OPM",
            "OPM Slow Motion Pad",
            "Soft original YM2151 pad with slow operator attacks, native LFO motion, and a long arcade release.",
            ChipMode::ym2151,
            AccuracyMode::hybrid,
            MacroKind::lead,
            PlayMode::chipPoly,
        ...
        },
        {
            ...
            "YM2610B / OPNB2 Bass",
            "OPNB2 Six-FM Bass",
            "Original YM2610B bass with six FM lanes, feedback weight, and a restrained SSG octave.",
            ChipMode::ym2610b,
            AccuracyMode::hybrid,
            MacroKind::bass,
            PlayMode::stack,
            { 0.02f, 0.82f, 0.28f, 0.88f },
            { true, true, false, true },
            0.08f,
            1,
            2,
        ...
        },
        {
            ...
            "YM2610B / OPNB2 Bass",
            "OPNB2 SSG Bass",
            "Tight OPNB2 bass patch with extra FM body, embedded SSG tone support, and clipped arcade edge.",
            ChipMode::ym2610b,
            AccuracyMode::hybrid,
            MacroKind::bass,
            PlayMode::chipPoly,
            { 0.14f, 0.64f, 0.36f, 0.86f },
            { true, true, true, true },
            0.10f,
            1,
            2,
        ...
        },
        {
            ...
            "YM2610B / OPNB2 Leads",
            "OPNB2 Metallic Lead",
            "Bright YM2610B lead using parallel-carrier FM, six-lane support, and embedded SSG sparkle.",
            ChipMode::ym2610b,
            AccuracyMode::hybrid,
            MacroKind::lead,
            PlayMode::stack,
        ...
        },
        {
            ...
            "YM2610B / OPNB2 Leads",
            "OPNB2 Arcade Lead",
            "Clean YM2610B arcade lead with six FM lanes, quick operator attack, and SSG reinforcement.",
            ChipMode::ym2610b,
            AccuracyMode::hybrid,
            MacroKind::lead,
            PlayMode::chipPoly,
        ...
        {
            "opnb2-nine-voice-arp",
            "YM2610B / OPNB2 Arps",
            "OPNB2 Nine-Voice Arp",
            "Nine-lane YM2610B fake-chord arp layering six FM channels with all three embedded SSG tone lanes.",
            ChipMode::ym2610b,
            AccuracyMode::hybrid,
            MacroKind::arp,
            PlayMode::chipPoly,
        ...
        },
        {
            ...
            "YM2610B / OPNB2 Arps",
            "OPNB2 Power Arp",
            "Longer OPNB2 arpeggio gesture with wide FM chord motion, SSG lift, and stereo pan alternation.",
            ChipMode::ym2610b,
            AccuracyMode::hybrid,
            MacroKind::arp,
            PlayMode::chipPoly,
        ...
        },
        {
            ...
            "YM2610B / OPNB2 Keys",
            "OPNB2 Electric Keys",
            "Original YM2610B electric keys patch with soft operator envelopes, parallel carriers, and light SSG support.",
            ChipMode::ym2610b,
            AccuracyMode::hybrid,
            MacroKind::lead,
            PlayMode::chipPoly,
        ...
        },
        {
            ...
            "YM2610B / OPNB2 Keys",
            "OPNB2 Glass Pad",
            "Smooth OPNB2 pad using a slower operator envelope, six-FM chord support, and subtle SSG brightness.",
            ChipMode::ym2610b,
            AccuracyMode::hybrid,
            MacroKind::lead,
            PlayMode::chipPoly,
        ...
        {
            "opnb2-adpcm-perc-drum",
            "YM2610B / OPNB2 Drums",
            "OPNB2 ADPCM Perc Drum",
            "Short YM2610B FM percussion drum with SSG clicks and optional user-owned OPNB ADPCM sample-memory overlays.",
            ChipMode::ym2610b,
            AccuracyMode::hybrid,
            MacroKind::drum,
            PlayMode::stack,
        ...
        },
        {
            ...
            "YM2610B / OPNB2 Drums",
            "OPNB2 Impact Drum",
            "Aggressive YM2610B stacked FM/SSG drum impact with high feedback and a fast transient envelope.",
            ChipMode::ym2610b,
            AccuracyMode::hybrid,
            MacroKind::hit,
            PlayMode::stack,
        ...
        },
        {
            ...
            "YM2610B / OPNB2 SFX",
            "OPNB2 Pitch Laser",
            "YM2610B FM/SSG pitch laser with nine-lane bite for arcade game SFX gestures.",
            ChipMode::ym2610b,
            AccuracyMode::hybrid,
            MacroKind::laser,
            PlayMode::stack,
        ...
        },
        {
            ...
            "YM2610B / OPNB2 SFX",
            "OPNB2 Jump FX",
            "Quick upward YM2610B FM/SSG game effect with bright operator motion and SSG tone lift.",
            ChipMode::ym2610b,
            AccuracyMode::hybrid,
            MacroKind::jump,
            PlayMode::stack,
...
const std::vector<PresetQualityTarget>& presetQualityTargets()
{
    ...
    static const std::vector<PresetQualityTarget> targets {
        ...
        { ChipMode::ym2612, roles, { "fm", "operator", "dac", "feedback", "envelope", "lfo", "chord" }, "Furnace-informed OPN2 coverage: operator bass/leads/keys plus rhythm, native DT1 detune, DAC, native LFO motion, and SFX recipes." },
        { ChipMode::opl3, roles, { "fm", "operator", "rhythm", "wave", "bell", "4op" }, "Furnace-informed OPL coverage: two-op melodic voices, shared editable $104 4-op pairs with all four algorithms, rhythm mode, bells, basses, and DOS-style SFX." },
        ...
        { ChipMode::ym2151, roles, { "fm", "operator", "noise", "envelope", "lfo", "arcade" }, "Furnace-informed OPM coverage: arcade FM leads, basses, keys, native LFO motion, noise hits, and fast motion." },
        { ChipMode::ym2413, roles, { "fm", "operator", "custom", "rhythm", "envelope", "alarm" }, "Furnace-informed OPLL coverage: ROM instrument bass/leads/keys, editable user-patch slot 0, source-card-labeled rhythm slots, and compact SFX." },
        ...
        { ChipMode::ym2610, roles, { "fm", "opnb", "ssg", "operator", "feedback", "envelope", "neo", "adpcm" }, "Furnace-informed OPNB coverage: YM2610 four-FM Neo Geo-style basses/leads/keys/arps plus embedded SSG percussion, renderer/VST user-owned ADPCM-A/B sample-memory overlays, and SFX; conversion/editing and stronger validation remain planned." },
        { ChipMode::ym2610b, roles, { "fm", "opnb2", "opnb", "ssg", "operator", "feedback", "envelope", "neo", "adpcm", "chord" }, "Furnace-informed OPNB2 coverage: YM2610B six-FM Neo Geo-style basses/leads/keys/arps plus embedded SSG percussion, renderer/VST user-owned ADPCM-A/B sample-memory overlays, and SFX; conversion/editing and stronger validation remain planned." }
    };
...
std::string presetEngineFor(const PresetInfo& preset)
{
    switch (preset.chip)
    {
        ...
        case ChipMode::ym2610b: return "YM2610B OPNB2 FM+SSG";
...
std::vector<std::string> presetTagsFor(const PresetInfo& preset)
{
    ...
    switch (preset.chip)
    {
        ...
        case ChipMode::ym2610b:
            ...
            addPresetTag(tags, "operator");
            addPresetTag(tags, "envelope");
            if (preset.chip == ChipMode::ym2203 || preset.chip == ChipMode::ym2608 || preset.chip == ChipMode::ym2610 || preset.chip == ChipMode::ym2610b)
            ...
            if (preset.chip == ChipMode::ym2610b)
            {
                addPresetTag(tags, "opnb2");
                addPresetTag(tags, "opnb");
                addPresetTag(tags, "neo");
            }
            break;
...
std::array<float, 4> fmOperatorLevelsForPreset(const PresetInfo& preset)
{
    ...
    else if (preset.chip == ChipMode::ym2610b)
    {
        if (preset.id == "opnb2-six-fm-bass")
            return { 0.58f, 0.66f, 0.46f, 0.62f };
        if (preset.id == "opnb2-ssg-bass")
            return { 0.50f, 0.70f, 0.44f, 0.60f };
        if (preset.id == "opnb2-metallic-lead")
            return { 0.70f, 0.56f, 0.64f, 0.74f };
        if (preset.id == "opnb2-arcade-lead")
            return { 0.44f, 0.80f, 0.46f, 0.78f };
        if (preset.id == "opnb2-nine-voice-arp")
            return { 0.54f, 0.58f, 0.48f, 0.68f };
        if (preset.id == "opnb2-power-arp")
            return { 0.58f, 0.60f, 0.52f, 0.82f };
        if (preset.id == "opnb2-electric-keys")
            return { 0.36f, 0.70f, 0.40f, 0.66f };
        if (preset.id == "opnb2-glass-pad")
            return { 0.34f, 0.66f, 0.38f, 0.64f };
        if (preset.id == "opnb2-adpcm-perc-drum")
            return { 0.66f, 0.46f, 0.72f, 0.88f };
        if (preset.id == "opnb2-impact-drum")
            return { 0.72f, 0.44f, 0.64f, 0.88f };
        if (preset.id == "opnb2-pitch-laser")
            return { 0.66f, 0.42f, 0.76f, 0.70f };
        if (preset.id == "opnb2-jump-fx")
            return { 0.42f, 0.78f, 0.46f, 0.82f };
    }
