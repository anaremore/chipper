...
- Keep HiDPI and host restore behavior in mind. Default to the shared 1240 x 860 DAW-fit contract and the 1180 px compact-width floor. Preserve the smoke-tested chip-specific 720-900 px heights unless a deliberate fixed-size redesign changes code, smoke tests, and docs together.
...
- PSG chips: Tone/noise and attenuation choices should read as hardware mixer/register behavior, with modern helpers labeled as helpers. SN76489 noise mode belongs in the Noise source card; do not show a separate empty tone/noise panel after moving that control.
