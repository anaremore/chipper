...
| OPL2 / OPL3 | Verified-partial BSD-3-Clause `ymfm` YMF262/OPL3 adapter with a unified nine-lane topology surface for native rhythm, paired 18-channel layers, and first-pass `$104` 4-op pairs; deep per-operator/full four-op editing remains planned |
