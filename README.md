...
- UI readability wins over density, but the default editor must remain DAW-friendly. Chip-specific layouts may rebalance inside the 1240 x 880 editor cap when that preserves standard-height controls, visible level lanes, and waveform previews without opening off-screen by default.
