...
| OPL2 / OPL3 | Verified-partial BSD-3-Clause `ymfm` YMF262/OPL3 adapter with nine visible source cards, native rhythm mode, and explicit paired 18-channel OPL3 layer mode; dedicated 18-card/four-op editing planned |
