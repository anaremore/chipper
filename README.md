...
| YM2608 / OPNA | Verified-partial BSD-3-Clause `ymfm` OPNA adapter with six FM lanes, three embedded SSG lanes, generated/user-owned encoded ADPCM-A rhythm banks, and ADPCM-B memory that accepts raw bytes or deterministic WAV/AIFF conversion at 5200 Hz with decoded preview and project fallback; six-region ADPCM-A editing and stronger validation remain planned |
| YM2610 / OPNB | Verified-partial BSD-3-Clause `ymfm` OPNB adapter with four FM lanes, three embedded SSG lanes, user-packed six-region ADPCM-A banks, and ADPCM-B memory that accepts raw bytes or deterministic WAV/AIFF conversion at 5208.333 Hz with decoded preview and project fallback; bank editing and stronger validation remain planned |
| YM2610B / OPNB2 | Verified-partial BSD-3-Clause `ymfm` OPNB2 adapter using the YM2610 six-FM channel mask, three embedded SSG lanes, the same user-packed ADPCM-A bank workflow, and raw or WAV/AIFF-converted ADPCM-B memory; bank editing and stronger validation remain planned |
