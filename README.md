...
| YM2612 / Genesis FM | Verified-partial BSD-3-Clause `ymfm` OPN2 adapter with native LFO Depth, Operator Tone DT1 detune, and channel-6 DAC drum playback from generated or VST/renderer-loaded WAV, AIFF, or raw unsigned DAC bytes with portable path recall; exact DAC timing and hardware validation remain planned |
