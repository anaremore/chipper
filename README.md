...
| YM2608 / OPNA | Verified-partial BSD-3-Clause `ymfm` OPNA adapter with six FM lanes, three embedded SSG tone/noise/envelope lanes, and generated ADPCM-A rhythm overlay for Drum/Hit macros with renderer and VST support for user-owned rhythm ROM bytes; ADPCM-B/user samples are planned |
