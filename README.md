...
| YM2612 / Genesis FM | Verified-partial BSD-3-Clause `ymfm` OPN2 adapter with native LFO Depth, Operator Tone DT1 detune, and channel-6 DAC drum playback from generated or renderer-fed unsigned DAC bytes; VST DAC file/state UX remains planned |
