...
| SNES SPC700-style | Lo-fi sample playback | Needs separate core/sampler design | Audit required | Planned; descriptor discloses sample/DSP design need, sample-voice UI intent, and missing BRR/echo/voice scheduling |
| Atari POKEY | Polynomial counters, distortion, timers | Clean-room or permissive emulator core | Audit required | Planned; descriptor discloses clean-room/permissive-first strategy, POKEY channel/distortion UI intent, and missing polynomial/timer core |
| Amiga Paula | Tracker sample channels, DMA-style playback | Clean-room sampler model feasible | Internal possible | Planned; descriptor discloses clean-room tracker sampler strategy, four-channel sample UI intent, and missing DMA/period/loop validation |
| PC Engine HuC6280 | Wavetable channels, noise, LFO | Clean-room register model feasible | Internal possible | Planned; descriptor discloses clean-room wavetable/noise strategy, waveform RAM UI intent, and missing wave/noise/LFO core |
