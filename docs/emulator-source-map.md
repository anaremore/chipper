...
| YM2612 / Genesis FM | ymfm vendored at `17decfae857b92ab55fbb30ade2287ace095a381` | Nuked-OPN2, Game_Music_Emu, Furnace | ymfm now backs the first verified-partial six-channel melodic adapter; add a full six-lane UI, DAC, LFO, and golden comparisons before increasing accuracy claims |
