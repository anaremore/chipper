...
| YM2151 / arcade FM | ymfm vendored at `17decfae857b92ab55fbb30ade2287ace095a381` | Furnace, MAME | ymfm backs the verified-partial OPM adapter with eight exposed lanes, pan, native LFO PM/AM depth/sensitivity, `$0F` channel-8 noise, and a dedicated shared four-operator editor; add independent per-channel patches, deeper LFO waveform/sensitivity UI, DT1/DT2 detune, timer/CSM controls, exact noise validation, and golden comparisons before increasing accuracy claims |
