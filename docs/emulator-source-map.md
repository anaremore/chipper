...
| YM2612 / Genesis FM | ymfm vendored at `17decfae857b92ab55fbb30ade2287ace095a381` | Nuked-OPN2, Game_Music_Emu, Furnace | ymfm now backs the verified-partial six-channel melodic adapter with all six source lanes exposed, first-pass native LFO rate/AMS/PMS controls, and partial channel-6 DAC drums; add a dedicated operator UI, user DAC sample import, detune, and golden comparisons before increasing accuracy claims |
