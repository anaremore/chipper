...
| YM2151 / arcade FM | ymfm vendored at `17decfae857b92ab55fbb30ade2287ace095a381` | Furnace, MAME | ymfm now backs the verified-partial OPM adapter with eight exposed lanes, pan, and first `$0F` channel-8 noise control; add a dedicated operator UI, OPM LFO/timer controls, exact noise validation, and golden comparisons before increasing accuracy claims |
