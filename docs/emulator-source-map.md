...
| --- | --- | --- |
| [ymfm](https://github.com/aaronsgiles/ymfm) | YM2612/OPN2 with first-pass native LFO Depth, DT1 detune, and generated/renderer-fed DAC byte playback, YM2203/OPN FM plus SSG tone/noise/envelope, YM2608/OPNA FM plus SSG tone/noise/envelope plus generated/default-or-user ADPCM-A rhythm overlay and first-pass ADPCM-B sample memory, YM2610/OPNB FM plus SSG tone/noise/envelope plus first-pass renderer/VST ADPCM-A/B sample memory, YM2610B/OPNB2 six-FM plus SSG tone/noise/envelope plus first-pass renderer/VST ADPCM-A/B sample memory, OPL2/OPL3 rhythm plus paired 18-channel high-bank layer mode and shared editable `$104` 4-op pairs with all four algorithms, and YM2151/OPM now; OPNA/OPNB ADPCM conversion/editing/golden validation and deeper OPL3 per-lane/flag/routing validation remain future candidates | BSD-3-Clause; vendored at `17decfae857b92ab55fbb30ade2287ace095a381`; core source headers inspected carry BSD-3-Clause, README notes MAME origins/design and high-audible-accuracy rather than cycle-accuracy goals |
...
| YM2608 / OPNA | ymfm vendored at `17decfae857b92ab55fbb30ade2287ace095a381` | Furnace, MAME | ymfm now backs the verified-partial six-channel FM adapter plus embedded SSG tone/noise/envelope lanes with all nine source lanes exposed; Drum/Hit macros trigger native ADPCM-A rhythm registers from generated bytes or renderer/VST-supplied user-owned ROM bytes, plus first-pass encoded ADPCM-B sample memory. Add ADPCM-B conversion/editing, timer/prescaler validation, and golden references before increasing accuracy claims |
| YM2610 / OPNB | ymfm vendored at `17decfae857b92ab55fbb30ade2287ace095a381` | Furnace, MAME | ymfm now backs the verified-partial four-channel FM adapter plus embedded SSG tone/noise/envelope lanes with all seven source lanes exposed; Drum/Hit macros can trigger renderer/VST-supplied user-owned encoded ADPCM-A/B byte memory. Add ADPCM conversion/editing, timer/prescaler validation, and golden references before increasing accuracy claims |
| YM2610B / OPNB2 | ymfm vendored at `17decfae857b92ab55fbb30ade2287ace095a381` | Furnace, MAME | ymfm now backs the verified-partial six-channel OPNB2 FM adapter through the YM2610 six-FM channel mask, plus embedded SSG tone/noise/envelope lanes with all nine source lanes exposed; Drum/Hit macros can trigger renderer/VST-supplied user-owned encoded ADPCM-A/B byte memory. Add ADPCM conversion/editing, timer/prescaler validation, and golden references before increasing accuracy claims |
