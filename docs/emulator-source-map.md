...
| YM2151 / arcade FM | ymfm vendored at `17decfae857b92ab55fbb30ade2287ace095a381` | Furnace, MAME | ymfm backs the verified-partial OPM adapter with eight exposed lanes, pan, direct native LFO waveform/PM/AM depth and sensitivity controls, `$0F` channel-8 noise, and a dedicated shared four-operator editor; add independent per-channel patches, DT1/DT2 detune, timer/CSM controls, exact noise validation, and golden comparisons before increasing accuracy claims |
