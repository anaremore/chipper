...
| OPL2 / OPL3 / DOS FM | ymfm vendored at `17decfae857b92ab55fbb30ade2287ace095a381` for YMF262/OPL3 | Nuked-OPL3, Furnace | ymfm now backs the verified-partial OPL2/OPL3 adapter with rhythm mode, explicit 18-channel Layer mode, and first-pass `$104` 4-op Pair mode. Add deeper OPL3 stereo routing, dedicated 18-card/four-op editing, golden validation, and hardware references before increasing OPL3 claims |
