...
| YM2151 / arcade FM | ymfm vendored at `17decfae857b92ab55fbb30ade2287ace095a381` | Furnace, MAME | ymfm now backs the verified-partial OPM adapter with eight exposed lanes, pan, first-pass native LFO PM/AM depth/sensitivity, and `$0F` channel-8 noise control; add a dedicated operator UI, deeper LFO waveform/sensitivity UI, DT1/DT2 detune, timer controls, exact noise validation, and golden comparisons before increasing accuracy claims |
