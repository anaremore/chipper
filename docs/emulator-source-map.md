...
| YM2413 / OPLL | emu2413 vendored; ymfm remains broader FM candidate | Nuked-OPLL, Furnace | emu2413 MIT core is used for the partial OPLL melodic-channel, native rhythm, and editable user-patch slot 0 adapter; keep Nuked-OPLL reference-only unless licensing changes |
