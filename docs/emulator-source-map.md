...
| YM2608 / OPNA | ymfm vendored at `17decfae857b92ab55fbb30ade2287ace095a381` | Furnace, MAME | ymfm now backs the verified-partial six-channel FM adapter plus embedded SSG tone/noise/envelope lanes with all nine source lanes exposed; Drum/Hit macros trigger native ADPCM-A rhythm registers from generated bytes or renderer-supplied user-owned ROM bytes. Add ADPCM-B/user samples, polished plugin rhythm-ROM UI, timer/prescaler validation, and golden references before increasing accuracy claims |
| YM2610 / OPNB | ymfm vendored at `17decfae857b92ab55fbb30ade2287ace095a381` | Furnace, MAME | ymfm now backs the verified-partial four-channel FM adapter plus embedded SSG tone/noise/envelope lanes with all seven source lanes exposed; add external ADPCM-A/B, YM2610B/OPNB2 six-FM behavior, timer/prescaler validation, and golden references before increasing accuracy claims |
