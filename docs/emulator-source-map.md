...
| YM2608 / OPNA | ymfm vendored at `17decfae857b92ab55fbb30ade2287ace095a381` | Furnace, MAME | ymfm now backs the verified-partial six-channel FM adapter plus embedded SSG tone/noise/envelope lanes with all nine source lanes exposed; Drum/Hit macros trigger generated native ADPCM-A rhythm registers. Add ADPCM-B/user samples, optional user-owned rhythm ROM loading, timer/prescaler validation, and golden references before increasing accuracy claims |
