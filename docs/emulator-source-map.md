...
| --- | --- | --- |
| [ymfm](https://github.com/aaronsgiles/ymfm) | YM2612/OPN2 with first-pass native LFO Depth, DT1 detune, and generated/renderer-fed DAC byte playback, YM2203/OPN FM plus SSG tone/noise/envelope, YM2608/OPNA FM plus SSG tone/noise/envelope, generated/default-or-user ADPCM-A rhythm banks, and raw or WAV/AIFF-converted ADPCM-B memory, YM2610/OPNB FM plus SSG tone/noise/envelope, user-packed ADPCM-A banks, and raw or WAV/AIFF-converted ADPCM-B memory, YM2610B/OPNB2 six-FM plus SSG tone/noise/envelope, user-packed ADPCM-A banks, and raw or WAV/AIFF-converted ADPCM-B memory, OPL2/OPL3 rhythm plus paired 18-channel high-bank layer mode and shared editable `$104` 4-op pairs with all four algorithms, and YM2151/OPM now; OPNA/OPNB six-region ADPCM-A editing and golden validation and deeper OPL3 per-lane/flag/routing validation remain future candidates | BSD-3-Clause; vendored at `17decfae857b92ab55fbb30ade2287ace095a381`; core source headers inspected carry BSD-3-Clause, README notes MAME origins/design and high-audible-accuracy rather than cycle-accuracy goals |
...
| YM2608 / OPNA | ymfm vendored at `17decfae857b92ab55fbb30ade2287ace095a381` | Furnace, MAME | ymfm backs the verified-partial six-channel FM plus embedded SSG adapter. Drum/Hit uses generated or user-owned encoded ADPCM-A rhythm banks and raw or deterministically WAV/AIFF-converted ADPCM-B memory. Codec vectors follow the vendored ymfm predictor/step rules. Add six-region ADPCM-A editing, timer/prescaler validation, and golden references before increasing accuracy claims |
| YM2610 / OPNB | ymfm vendored at `17decfae857b92ab55fbb30ade2287ace095a381` | Furnace, MAME | ymfm backs the verified-partial four-channel FM plus embedded SSG adapter. Drum/Hit uses a user-packed six-region ADPCM-A bank and raw or deterministically WAV/AIFF-converted shared ADPCM-B memory. Add six-region bank editing, fuller sample editing, timer/prescaler validation, and golden references before increasing accuracy claims |
| YM2610B / OPNB2 | ymfm vendored at `17decfae857b92ab55fbb30ade2287ace095a381` | Furnace, MAME | ymfm backs the verified-partial six-channel OPNB2 adapter through the YM2610 six-FM channel mask, with embedded SSG lanes, user-packed ADPCM-A memory, and the same raw-or-converted ADPCM-B workflow. Add six-region bank editing, fuller sample editing, timer/prescaler validation, and golden references before increasing accuracy claims |
