...
| YM2608 / OPNA | ymfm vendored at `17decfae857b92ab55fbb30ade2287ace095a381` | Furnace, MAME | ymfm now backs the verified-partial six-channel FM adapter plus embedded SSG tone/noise/envelope lanes with all nine source lanes exposed; add native rhythm, ADPCM-A/B, timer/prescaler validation, and golden references before increasing accuracy claims |
