...
- SID Performance Macros use a single-row strip under the protected ADSR module. Do not let the default two-row macro grid return for SID, because it compresses readouts and makes the macro surface feel like it is colliding with the ADSR editor.
