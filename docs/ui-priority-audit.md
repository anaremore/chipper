...
- PSG and FM pages should keep Performance Macros compact but stacked. YM2149/AY, SN76489, YM2612, YM2151, OPL, and OPLL must not squeeze long register hints into the same header row as slider labels; compact macro cells still reserve separate rows for label, slider, and resolved register readout before any chip-owned source/operator panel is compressed.
