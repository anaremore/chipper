...
- Dense sampler and wavetable cards reserve their bottom level lane before placing optional shape/sample selectors. This keeps per-channel gain readable for Paula, SPC700, HuC6280, Namco WSG, and SCC even when those cards grow more chip-aware controls.
