...
- NES / RP2A03 DMC sample controls should prioritize the sample bank and waveform preview over the APU envelope helper. APU decay is still useful, but the DMC waveform is the higher-value visual surface when users are loading and browsing samples.
