...
- HuC6280, Namco WSG, and SCC wavetable cards should stay compact but complete: waveform preview, per-lane wave selector, and a visible level lane. Reserve the level lane from the bottom of the card instead of letting empty preview/selector space push it out of view.
