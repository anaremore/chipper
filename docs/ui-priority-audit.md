...
- HuC6280, Namco WSG, and Konami SCC now have explicit helper-envelope modules with a visible shared amp-envelope slider/readout instead of letting the helper appear as Motion/Wave copy. The source cards remain the home for per-channel shape/sample/level editing.
