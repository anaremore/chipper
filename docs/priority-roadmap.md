...
| 6 | SNES SPC700-style | 8 | Current code is internal clean-room partial; GME/Furnace/MAME remain reference or audit targets only. | Replace the generic four-source view with eight sample-voice lanes, BRR/sample slots, ADSR/gain controls, and honest echo/FIR status. |
...
| 7 | SPC700-style deeper pass | Make the new partial lo-fi sample-voice core feel like a first-class SNES-style instrument. | Continue clean-room; audit GME/Furnace/MAME references before any reuse. | Eight sample voices with BRR/sample slots, ADSR/gain, pitch modulation status, echo color, and clear "style" labeling. | 6 |
