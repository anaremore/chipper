...
| ---: | --- | ---: | --- | --- |
| 1 | YM2610 / OPNB ADPCM-A/B + OPNB2 | 8 | Add external ADPCM-A/B workflow and then YM2610B six-FM behavior. | Neo Geo identity is incomplete without ADPCM, and the OPNA ADPCM-B path now gives us a safer pattern for user-owned encoded sample bytes, state recall, renderer JSON, and VST UI. |
