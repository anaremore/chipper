...
- Keep the plugin DAW-fit first. Compact chip pages open at 660 px tall and sample-heavy Paula/SPC700 pages cap at 720 px so high-DPI hosts do not reopen Chipper off-screen; any future layout work has to fit inside those chip-specific budgets or introduce a deliberate secondary view.
