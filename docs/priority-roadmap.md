...
| 7 | Amiga Paula | 8 | Current code is internal clean-room partial; pt2-clone/libxmp/Furnace remain reference or audit targets only. | Replace the generic four-source view with tracker sample-channel strips, period/loop/volume controls, sample browser/import, and MOD-style retrigger vocabulary. |
| 8 | PC Engine HuC6280 | 7 | Current code is internal clean-room partial; MAME/GME/Furnace/HuSIC remain reference or audit targets only. | Replace the generic four-source view with six wavetable lanes, wave RAM visuals, noise/LFO controls, and PC Engine preset vocabulary. |
| 9 | Namco arcade WSG | 7 | Current code is internal clean-room partial; MAME/Furnace remain reference or audit targets only. | Replace the generic four-source view with WSG lane banks, 4-bit wave RAM visuals, enable/volume controls, and arcade preset vocabulary. |
| 10 | Konami SCC | 7 | Current code is internal clean-room partial; emu2212 remains a permissive candidate/reference until audited. | Replace the generic four-source view with five wavetable lanes, wave RAM visuals/editing, key/volume controls, and Konami preset vocabulary. |
| 11 | YM2612 / OPN2 and OPL2/OPL3 | 8 | Do not start VST UI exposure until an FM core license plan is chosen and documented. | Use a real operator/algorithm UI with envelope visuals instead of generic oscillator controls. |
...
| 10 | SCC deeper pass | Turn the new partial Konami SCC core into a first-class five-channel wavetable instrument. | Continue clean-room; audit `emu2212` before any reuse. | Five wavetable strips with wave edit/slot, level, tuning, key mask, and stack/spread macros. | 7 |
