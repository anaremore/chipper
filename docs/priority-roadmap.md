...
- Keep wavetable source decks compact. HuC6280, Namco WSG, and SCC cards should reserve enough height for waveform preview, selector, and level, but should not stretch into tall blank panels.
