...
- Chip Mode: NES/RP2A03, Game Boy/DMG, SID/C64, YM2149/AY, SN76489, YM2612, OPL2/OPL3, SPC700, POKEY, Paula, HuC6280, Namco WSG, YM2151, YM2413/OPLL, SCC, YM2203/OPN
...
- None at the moment. YM2612/OPN2, YM2203/OPN, and OPL2/OPL3 now have audible verified-partial cores and renderer-exported factory preset catalogs. Future preset targets should be added only after confirming the chip has an audible engine path, stable state recall, and clean provenance.
