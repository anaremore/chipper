...
- Non-parameter Motion Lab project state: per-chip enable, 1-8 step length, 1/8-1/64 rate, eight -24..+24 semitone offsets, eight 0-15 post-chip levels, and Hold/Trig/Cut gates. These are not APVTS automation slots; the engine publishes edits lock-free and saves them in schema-v5 project/preset state.
