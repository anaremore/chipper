...
- **OPL2/OPL3:** two-operator FM, rhythm mode, waveform variants, envelopes, OPL3 stereo output, explicit paired 18-channel Layer mode, and `$104` 4-op Pair mode with all four YMF262 algorithms and one shared editable OP1-OP4 multiplier/total-level/AR/DR/SL/RR matrix.
