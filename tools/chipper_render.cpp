...
bool parseArgs(int argc, char** argv, Options& options)
{
    for (int i = 1; i < argc; ++i)
    {
        ...
        else if (arg == "--stereo-spread" || arg == "--opm-lfo-depth" || arg == "--ym2151-lfo-depth" || arg == "--opm-lfo")
        {
            const auto* value = requireValue(arg.c_str());
