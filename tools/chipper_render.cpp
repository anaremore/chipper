...
bool parseArgs(int argc, char** argv, Options& options)
{
    for (int i = 1; i < argc; ++i)
    {
        ...
        else if (arg == "--opn2-pan" || arg == "--ym2612-pan")
        {
            const auto* value = requireValue(arg.c_str());
        ...
        else if (arg == "--opn2-envelope" || arg == "--ym2612-envelope")
        {
            const auto* value = requireValue(arg.c_str());
