...
int main()
{
    ...
    ok &= expectSegmentedRegister(chipper::ChipMode::nes, chipper::ChipParameterRole::pulse2Duty, 5, "Macro");
    ...
    ok &= expectSpec(chipper::ChipMode::sid, chipper::ChipParameterRole::sidDecay, chipper::ParameterKind::chipRegister, chipper::ControlSurface::menu, "V1 Decay");
    ok &= expectSpec(chipper::ChipMode::sid, chipper::ChipParameterRole::sidSustain, chipper::ParameterKind::chipRegister, chipper::ControlSurface::menu, "V1 Sustain");
    ok &= expectSpec(chipper::ChipMode::sid, chipper::ChipParameterRole::sidRelease, chipper::ParameterKind::chipRegister, chipper::ControlSurface::menu, "V1 Release");
    ok &= expectSpec(chipper::ChipMode::sid, chipper::ChipParameterRole::sidVoice2Attack, chipper::ParameterKind::chipRegister, chipper::ControlSurface::menu, "V2 Attack");
    ok &= expectSpec(chipper::ChipMode::sid, chipper::ChipParameterRole::sidVoice2Decay, chipper::ParameterKind::chipRegister, chipper::ControlSurface::menu, "V2 Decay");
    ok &= expectSpec(chipper::ChipMode::sid, chipper::ChipParameterRole::sidVoice2Sustain, chipper::ParameterKind::chipRegister, chipper::ControlSurface::menu, "V2 Sustain");
    ok &= expectSpec(chipper::ChipMode::sid, chipper::ChipParameterRole::sidVoice2Release, chipper::ParameterKind::chipRegister, chipper::ControlSurface::menu, "V2 Release");
    ok &= expectSpec(chipper::ChipMode::sid, chipper::ChipParameterRole::sidVoice3Attack, chipper::ParameterKind::chipRegister, chipper::ControlSurface::menu, "V3 Attack");
    ok &= expectSpec(chipper::ChipMode::sid, chipper::ChipParameterRole::sidVoice3Decay, chipper::ParameterKind::chipRegister, chipper::ControlSurface::menu, "V3 Decay");
    ok &= expectSpec(chipper::ChipMode::sid, chipper::ChipParameterRole::sidVoice3Sustain, chipper::ParameterKind::chipRegister, chipper::ControlSurface::menu, "V3 Sustain");
    ok &= expectSpec(chipper::ChipMode::sid, chipper::ChipParameterRole::sidVoice3Release, chipper::ParameterKind::chipRegister, chipper::ControlSurface::menu, "V3 Release");
